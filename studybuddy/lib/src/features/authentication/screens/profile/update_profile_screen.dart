...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void IsFormFilled() {
    if (controller.college.text.isNotEmpty &&
        controller.major.text.isNotEmpty &&
        controller.classYear.text.isNotEmpty) {
      isFormFilled = true;
    }
  }
            ...
            Scaffold(
              appBar: buildAppBar(
                  ...
                  actions: [
                    ...
                    //             // Logout icon
                    //             SizedBox(width: 10),
                    //             Text('Logout', style: TextStyle(color: Colors
                    //                 .red)),
              ...
              floatingActionButton: FloatingActionButton(
                onPressed: () {
                  if (controller.college.text.isNotEmpty &&
                      controller.major.text.isNotEmpty &&
                      controller.classYear.text.isNotEmpty) {
                    // If all fields are filled out, save the profile and navigate to the next screen
                    ...
                    // If any field is not filled out, show an error message
